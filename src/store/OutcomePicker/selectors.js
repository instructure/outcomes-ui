...
export const getSelectedLaunchContext = createSelector(
  (state, scope) => restrict(state, scope).get('selectedLaunchContext'),
  (selectedLaunchContext) => selectedLaunchContext ? selectedLaunchContext.toJS() : null
)
