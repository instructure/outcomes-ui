...
export const SET_LAUNCH_CONTEXTS = 'SET_LAUNCH_CONTEXTS'
...
export const RESET_EXPANDED_IDS = 'RESET_EXPANDED_IDS'
export const SET_SCOPE = 'SET_SCOPE'
export const RESET_OUTCOME_PICKER = 'RESET_OUTCOME_PICKER'
export const SET_SELECTED_LAUNCH_CONTEXT = 'SET_SELECTED_LAUNCH_CONTEXT'
